...
if menu_num == 1: # 햄버거 세트
    ...
    choice_num = choice_menu.choice_burger() # choice_menu.py에서 choice.burger() 함수를 호출하세요.
    ...
    menu_save['side'] = side_name[choice_num2]  # 사용자가 선택한 사이드메뉴 기록
    price_save['side'] = side_price[choice_num2]  # 사용자가 선택한 사이드메뉴의 가격 기록

    # 음료 단품 세부 메뉴 선택
    choice_num3 = choice_menu.choice_drink()
    menu_save['drink'] = drink_name[choice_num3]  # 사용자가 선택한 음료메뉴 기록
    price_save['drink'] = drink_price[choice_num3]  # 사용자가 선택한 음료메뉴의 가격 기록
